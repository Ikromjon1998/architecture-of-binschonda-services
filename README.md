...
graph TD
    ...
    subgraph BCFlow [Business Client Flow]
        ...
        Services -->|Under Category & Area of Service| AreaService
        Services -->|Approval Request for Names & Fields| DB
        Services -->|Create SubServices| SubServices[Sub Services]
        SubServices -->|Under Category, Area of Service, & Service| Services
